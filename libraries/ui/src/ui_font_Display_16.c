 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --bpp 1 --size 16 --font C:/Users/761681/SquareLine/assets/Open 24 Display St.ttf -o C:/Users/761681/SquareLine/assets\ui_font_Display_16.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/

#include "ui.h"

#ifndef UI_FONT_DISPLAY_16
#define UI_FONT_DISPLAY_16 1
#endif

#if UI_FONT_DISPLAY_16
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ui_font_Display_16 = {
#else
lv_font_t ui_font_Display_16 = {
#endif
